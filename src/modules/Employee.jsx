...
export const MODULE_SECTIONS = {
  ...
  analytics:     [{ id: "analytics", label: "Referral" }, { id: "an_earned", label: "Earned Revenue" }, { id: "an_aop", label: "AOP", adminOnly: true }, { id: "an_billing", label: "Billing" }, { id: "an_revenue", label: "Revenue" }, { id: "an_penetration", label: "Penetration Tracker" }, { id: "an_credits", label: "Credits" }, { id: "an_applogs", label: "App Logs" }],
  ...
  fsm:           [{ id: "fsm_ops", label: "Ops Command" }, { id: "fsm_satisfaction", label: "Customer Satisfaction" }, { id: "fsm_track", label: "Track Technician" }],
