/* ===========================================================================
   ...
   AnalyticsOverview, SalesInsights (an_sales — NOT the Sales module),
   CreditsAnalytics, NetRevenue, PenetrationTracker, BillingAnalytics,
   AppLogs, EarnedRevenue, Reconciliation (an_reconciliation), DPTransactions,
   AOP, ChurnRiskRadar, ApartmentPerformance + creditNoteApi/appLogsApi and
   their config. Biggest and most complex module, extracted last per plan.
   =========================================================================== */
import React, { useState, useEffect, useRef } from "react";
import {
  AlertCircle, ArrowDown, ArrowUp, ArrowUpDown, Ban, Boxes, Briefcase,
